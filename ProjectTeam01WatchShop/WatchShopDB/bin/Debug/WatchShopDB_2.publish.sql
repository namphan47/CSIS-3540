...
:setvar DefaultDataPath "C:\Users\ronak\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
:setvar DefaultLogPath "C:\Users\ronak\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\"
...
GO
PRINT N'Creating [dbo].[MasterRole]...';
...
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [FK_Employee_Role] FOREIGN KEY ([RoleID]) REFERENCES [dbo].[MasterRole] ([RoleID]);
...
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Employee] FOREIGN KEY ([EmpID]) REFERENCES [dbo].[Employee] ([EmpId]);
...
GO
ALTER TABLE [dbo].[Orders]
    ADD CONSTRAINT [FK_Orders_Transactions] FOREIGN KEY ([TransactionID]) REFERENCES [dbo].[Transactions] ([TransactionID]);
...
ALTER TABLE [dbo].[Transactions]
    ADD CONSTRAINT [FK_Transactions_Employee] FOREIGN KEY ([EmpCashierID]) REFERENCES [dbo].[Employee] ([EmpId]);
